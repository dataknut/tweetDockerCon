...
myPlot + 
  ...
  annotate("text", 
           ...
           y = 100,
           label = c("Ben Golub's keynote")
           ) +
  annotate("rect", 
           xmin = as.POSIXct("2017-04-19 09:00:00"), 
           xmax = as.POSIXct("2017-04-19 09:15:00"), 
           ymin = 0, 
           ymax = 80, alpha = .2) +
  annotate("text", 
           x = as.POSIXct("2017-04-19 09:00:00"), 
           y = 80,
           label = c("Day 2 general session")
           ) +
annotate("rect", 
           xmin = as.POSIXct("2017-04-19 16:45:00"), 
           xmax = as.POSIXct("2017-04-19 17:00:00"), 
           ymin = 0, 
           ymax = 100, alpha = .2) +
  annotate("text", 
           x = as.POSIXct("2017-04-19 16:45:00"), 
           y = 100,
           label = c("Docker Cool hacks session")
           )
```
